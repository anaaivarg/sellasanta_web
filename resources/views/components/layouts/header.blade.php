<header class="bg-white flex items-center justify-between px-4 h-16 sticky top-0 z-50">
    <div class="navbar bg-white h-full flex items-center">
        <div class="ps-4">
            <a class="text-lg font-bold">LOGO</a>
        </div>
        <div class="flex grow justify-end px-8">
            <div class="flex space-x-8">
                ...
                <div class="dropdown dropdown-end">
                    ...
                    <ul tabindex="-1" class="menu dropdown-content bg-white z-10 mt-6 w-52 p-2 shadow-sm">
                        <li><a href="{{ route('cofradia') }}#origen" class="text-moradoprin hover:text-orange-600 font-bold">Origen</a></li>
                        <li><a href="{{ route('cofradia') }}#estandartes" class="text-moradoprin hover:text-orange-600 font-bold">Estandartes</a></li>
                    </ul>
                </div>
