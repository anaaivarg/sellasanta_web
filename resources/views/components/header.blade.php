        ...
        <div class="flex grow justify-end px-8">
            <div class="flex space-x-8">
                ...
                <a href="{{ route('login') }}"><button
                        class="text-moradoprin hover:text-orange-600 bg-transparent border-0 p-0 cursor-pointer font-bold">Area
                        privada</button></a>
                @auth

                    {{-- <span>Hola {{ auth()->user()->name }}</span> --}}
                    <a href="{{ route('logout') }}"
                       class="text-moradoprin hover:text-orange-600 bg-transparent border-0 p-0 cursor-pointer font-bold">
                        Salir
                    </a>
